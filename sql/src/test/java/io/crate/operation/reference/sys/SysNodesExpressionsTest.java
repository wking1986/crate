...
public class SysNodesExpressionsTest extends CrateUnitTest {
    ...
    public void testFs() throws Exception {
        ...
        assertThat((String) disk0.get("dev"), is(resolvePath("/dev/sda1")));
        assertThat((Long) disk0.get("size"), is(42L));

        Map<String, Object> disk1 = (Map<String, Object>) disks[1];
        assertThat((String) disk1.get("dev"), is(resolvePath("/dev/sda2")));
        assertThat((Long) disk0.get("used"), is(42L));

        Object[] data = (Object[]) v.get("data");
        assertThat(data.length, is(2));
        assertThat((String) ((Map<String, Object>) data[0]).get("dev"), is(resolvePath("/dev/sda1")));
        assertThat((String) ((Map<String, Object>) data[0]).get("path"), is(resolvePath("/foo")));

        assertThat((String) ((Map<String, Object>) data[1]).get("dev"), is(resolvePath("/dev/sda2")));
        assertThat((String) ((Map<String, Object>) data[1]).get("path"), is(resolvePath("/bar")));
